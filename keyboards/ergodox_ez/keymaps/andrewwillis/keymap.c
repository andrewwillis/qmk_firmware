...
#define NUMPAD 4 // a numpad

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
/* Keymap 0: Basic layer
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  Grv   |   1  |   2  |   3  |   4  |   5  | ESC  |           | CAPS |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  Tab   |   Q  |   W  |   E  |   R  |   T  |  L1  |           | [/{  |   Y  |   U  |   I  |   O  |   P  |  ]/}   |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |   L3   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2|   '"   |
 * |--------+------+------+------+------+------| NUM  |           |  L1  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  | L4   |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Ctrl |  '"  | \/|  | =/+  | LGui |                                       | Left | Down |  Up  | Right| LGui |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | LCtrl| LAlt |       | RAlt | LCtl |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,   CTL_T(KC_Z),  KC_X,      KC_C,   KC_V,     KC_B,   TG(NUMPAD),
...
[NUMPAD] = LAYOUT_ergodox(
       ...
       _______, _______, _______, _______, _______, _______, TG(NUMPAD),
       _______, _______, _______, _______, _______,
                                           _______, _______,
                                                    _______,
                                  _______, _______, _______,
    // right hand
       _______,  _______, _______, KC_KP_SLASH, KC_KP_ASTERISK, KC_KP_MINUS, _______,
